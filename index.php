<link rel="icon" href="./R.png" type="image/png" size="50px">
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">SISTA<br><i style="font-size:14px;">STT Nurul Fikri</i></a>
            </div>
...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa fa-users "></i>MEMBER SISTA <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
    ...
    <div id="footer-sec">
        &copy; 2016 8.5 Web Grup(q) Gefivenco. All Right Reserved <span style="float:right;">Design By : <b>Pelajar SMPN 1 Metro</b>
    </div>
    <!-- /. FOOTER  -->
    <!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
    <!-- JQUERY SCRIPTS -->
